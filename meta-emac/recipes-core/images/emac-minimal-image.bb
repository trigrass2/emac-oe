...
PACKAGE_FEED_URIS ?= "${@bb.utils.contains_any("EMAC_PACKAGEMANAGER", "deb ipk rpm", " \
    http://ftp.emacinc.com/openembedded-sw/${DISTRO_CODENAME}-${DISTRO_VERSION}/latest/${MACHINE}", "", d)}"
